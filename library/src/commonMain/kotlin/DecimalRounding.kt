...
internal fun roundWithMode(rawMantissa: Long, rawDecimals: Int, desiredDecimals: Int = Decimal.autoDecimalPlaces, roundingMode: Decimal.RoundingMode=Decimal.autoRoundingMode): Pair<Long, Int> {
