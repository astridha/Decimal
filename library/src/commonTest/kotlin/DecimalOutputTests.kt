...
class DecimalOutputTests {
    ...
    @Test fun toStringTests() {
        ...
        var displayFormat = Decimal.Locale(null, '.',3)
        assertEquals(
            "1.000",
            Decimal(1L).toString(displayFormat),
            "toString:  decimal is dot (default)"
        )
        displayFormat = Decimal.Locale(null, ',',3)
        assertEquals(
            "1,000",
            Decimal(1L).toString(displayFormat),
